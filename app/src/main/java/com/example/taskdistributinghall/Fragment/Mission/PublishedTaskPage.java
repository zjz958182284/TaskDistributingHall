...
public class PublishedTaskPage extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView=view.findViewById(R.id.published_task_recycler_view);
        ...
        PublishedPageRecyclerViewAdapter adapter=new PublishedPageRecyclerViewAdapter(listStr);
